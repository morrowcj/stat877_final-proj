...
## Univariate SNP association model:
...
\normalsize There are `r prettyNum(snps.n, big.mark = ",")` unique significant SNPs. 
...
(transmembrane oxireductases create electron-transport chains in chloroplasts and mitochondria)

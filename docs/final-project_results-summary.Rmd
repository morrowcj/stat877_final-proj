...
to test robustly test for genotype associations while accounting for aspen 
...
total, `r 18*114420` GLMMs were created, one for each insect by SNP combination.
...
in the same genomic region (**table 2**). This indicates that a true loci of interest lies
...
knitr::kable(tab,col.names = c("SNP","Harmandia","Phyllocolpa","Petiole Gall"),
             caption = paste0("Table 2: q values for SNPs with 3 associations.",
